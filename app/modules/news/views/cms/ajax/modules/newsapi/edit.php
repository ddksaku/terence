<script>
    ...
    function ajaxValidationCallback(status, form, json, options){
            if (json.entry_exists) {
                    $('input[name="newstitle"]').validationEngine('showPrompt', 'Title already exists', 'error',"topLeft");
            }else{
                    Add_database_light_upnews(form, options);
            }
    }
...
$(document).ready(function(){	
	...
	$("#editor").cleditor()[0].disable(false).refresh();
        ...
        synergyTagsAutocomplete('#news_tags_input');
	...
	function Add_database_light_upnews (form, options){
		loading('Loading',0);
  ...
  <div class="header">
      <span>
          <?php if ($new_news): ?>
            ADD NEWS
          <?php else: ?>
            EDIT NEWS (<?php echo $news->news_title; ?>)
          <?php endif; ?>
      </span>
...
<form id="news_edit" action="newsapi/validate_news" name="news_edit" method="post">
                                        ...
                                        <div class="section">
                                            ...
                                            <div> 
                                              <select class="chzn-select" name="chzn-select[]" multiple tabindex="4">
                                                 ...
                                                 $in_categories = $news->categories->lists('category_title', 'category_id');
                                               ...
                                               <div>
                                                <div class="checkslide">
                                                    <input
                                                        ...
                                                        name="statusactive"
                                                        value="1"
                                                        <?php if($new_news || $news->news_active): ?>
                                                            checked
                                                        <?php endif; ?>
                                                        >
							...
							<?php if($news->news_image): ?>
                                                          <div class="img-preview-holder original_image">
                                                              <p class="img-preview">
                                                                  <img src="/uploads/images/resize/<?php echo $news->news_image; ?>?date=<?php echo time(); ?>" width="200">
                                                              </p>
     
                                                              <!-- Image Menu -->
                                                              <ul class="image-menu" data-img="<?php echo $news->news_image; ?>">
                                                      ...
                                                      <div id="progress" class="image-progress progress progress-success progress-striped active" style="display:none;">
                                                          <div class="bar"></div>
                                                      </div>
                                                  </div>
                                                  ...
                                                  <?php if($news->news_image): ?>
                                                    ...
                                                    <input id="original_file" name="original_file"  type="text" value="<?php echo $news->news_image ?>" style="display:none">
                                                  <?php else:?>
                                                  ...
                                                  <input id="imagefile" name="imagefile"  type="text" value="<?php echo $news->news_image; ?>" style="display:none">
                                          ...
                                          <!-- Upload Button End --> 
                                                ...
                                                <div><input type="text" class="large" name="imagename" value="<?php echo $news->news_image_alt; ?>"/></div>
                                           </div>
                                              ...
                                              <div>
                                                ...
                                                <div id="files-list" class="files">
                                                    ...
                                                    foreach ($news->files as $file) {
                                                        ?>
                                                        <p>
                                                            <span><a href="/cms/file-download/news/<?php echo $file->file_id; ?>"><?php echo $file->file_original_name; ?></a></span>
                                                            <br>
                                        ...
                                        <div class="section"> 
                                        <label>Date to Publish<small>Live date</small></label>   
                                        <div>
                                            <input
                                                type="text"
                                                id="datetimepicker"
                                                ...
                                                name="datetimepicker"
                                                <?php if ($news->hasPublishDate()): ?>
                                                    value="<?echo $news->getPublishDate(); ?>"
                                                <?php endif; ?>
                                                >
                                        </div>
                                    	</div>
                                        ...
                                        <div class="section">
                                          <label>News Title<small>Give your news item a title</small></label>   
                                          <div>
                                              <input
                                                  type="text"
                                        ...
                                        <div>
                                        <textarea name="Textarealimit" id="Textarealimit" class="validate[required] large" cols="" rows=""><?php echo $news->news_introduction; ?></textarea>
                                        ...
                                        <div> <textarea name="description" id="editor" class="editor" cols="5" rows=""><?php echo $news->news_description; ?></textarea></div>
                                        </div>
                                        
                                         <div class="section">
                                                 <label>Tags</label>   
                                               <div><input id="news_tags_input" type="text" class="tags" value="<?php echo implode(',', $news->tags->lists('tag_name')); ?>"  name="tags_input" /></div>   
                                   			</div>
