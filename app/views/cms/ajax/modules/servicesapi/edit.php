<script>
    ...
    function ajaxValidationCallback(status, form, json, options){
            if (json.entry_exists) {
                    $('input[name="servicestitle"]').validationEngine('showPrompt', 'Title already exists', 'error',"topLeft");
            }else{
                    Add_database_light_upservices(form, options);
            }
    }
...
$(document).ready(function(){	
	...
	$("#editor").cleditor()[0].disable(false).refresh();
        ...
        synergyTagsAutocomplete('#service_tags_input');
	...
	var prefix = "chzn_";
    $('#services_edit').validationEngine({
          prettySelect : true, 
          useSuffix: prefix,          
	...
	function Add_database_light_upservices (form, options){
		loading('Loading',0); 
  ...
  <div class="header">
      <span>
          <?php if ($new_service): ?>
            ADD SERVICE
          <?php else: ?>
            EDIT SERVICE (<?php echo $service->service_title; ?>)
          <?php endif; ?>
      </span>
...
<form id="services_edit" action="servicesapi/validate_service" name="services_edit" method="post">
                                        ...
                                        <div class="section">
                                            ...
                                            <div> 
                                              <select class="chzn-select" name="chzn-select[]" multiple tabindex="4">
                                                 ...
                                                 $in_categories = $service->categories->lists('category_title', 'category_id');
                                               ...
                                               <div>
                                                <div class="checkslide">
                                                    <input
                                                        ...
                                                        name="statusactive"
                                                        value="1"
                                                        <?php if($new_service || $service->service_active): ?>
                                                            checked
                                                        <?php endif; ?>
                                                        >
							...
							<?php if($service->service_image): ?>
                                                          <div class="img-preview-holder original_image">
                                                              <p class="img-preview">
                                                                  <img src="/uploads/images/resize/<?php echo $service->service_image; ?>?date=<?php echo time(); ?>" width="200">
                                                              </p>
     
                                                              <!-- Image Menu -->
                                                              <ul class="image-menu" data-img="<?php echo $service->service_image; ?>">
                                                  ...
                                                  <?php if($service->service_image): ?>
                                                    ...
                                                    <input id="original_file" name="original_file"  type="text" value="<?php echo $service->service_image ?>" style="display:none">
                                                  <?php else:?>
                                                  ...
                                                  <input id="imagefile" name="imagefile"  type="text" value="<?php echo $service->service_image; ?>" style="display:none">
                                          ...
                                          <!-- Upload Button End --> 
                                                ...
                                                <div><input type="text" class="large" name="imagename" value="<?php echo $service->service_image_alt; ?>"/></div>
                                           </div>
                                      ...
                                      <div id="file-upload-holder" class="section">
                                          ...
                                          <div>
                                                ...
                                                <div id="files-list" class="files">
                                                    ...
                                                    foreach ($service->files as $file) {
                                                        ?>
                                                        <p>
                                                            <span><a href="/cms/file-download/services/<?php echo $file->file_id; ?>"><?php echo $file->file_original_name; ?></a></span>
                                                            <br>
                                        ...
                                        <div class="section">
                                          <label>Service Title<small>Give your service item a title</small></label>   
                                          <div>
                                              <input
                                                  type="text"
                                                  class="validate[required] large"
                                                  name="servicestitle"
                                                  value="<?php echo $service->service_title; ?>"
                                                  >
                                          </div>
                                        </div>
                                        ...
                                        <div>
                                        <textarea name="Textarealimit" id="Textarealimit" class="validate[required] large" cols="" rows=""><?php echo $service->service_introduction; ?></textarea>
                                        ...
                                        <div> <textarea name="description" id="editor" class="editor" cols="5" rows=""><?php echo $service->service_description; ?></textarea></div>
                                        </div>
                                        
                                         <div class="section">
                                                 <label>Tags</label>   
                                               <div><input id="service_tags_input" type="text" class="tags" value="<?php echo implode(',', $service->tags->lists('tag_name')); ?>"  name="tags_input" /></div>   
                                   			</div>
                                            
                                            <div class="section last">
                                            <div id="save_services">
