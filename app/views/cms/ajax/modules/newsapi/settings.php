...
$(document).ready(function(){	
		    ...
		    $('#newssubmit-lightbox').validationEngine({
                    ...
                    function(data)
                    {
                        if(data.success==0){   // uncomplete return 0
                          ...
                          if(data.success==1){ // complete return 1
                                alertMessage("success","News settings changed.");
...
<div class="modal_dialog" style="min-height:50px">
    ...
    <div class="content">
        <form name="newssubmit" id="newssubmit-lightbox">
            
            <div class="section">
                <label>Image Sizes</label>
                <div>
                    <span class="f_help">Resize Width</span><input type="text"
                            name="setting_news_resize_width" id="resize_width"
                            class="validate[minSize[2],maxSize[3] ] small"
                            value="<?php echo $settings->setting_news_resize_width ?: ''; ?>" />
                    <span class="f_help">Thumb
                            Width</span><input type="text" name="setting_news_thumb_width" id="thumb_width"
                            class="validate[minSize[2],maxSize[3] ] small"
                            value="<?php echo $settings->setting_news_thumb_width ?: ''; ?>" />
                    <span class="f_help">Square
                            Width</span><input type="text" name="setting_news_square_width"
                            id="square_width"
                            class="validate[minSize[2],maxSize[3] ] small"
                            value="<?php echo $settings->setting_news_square_width ?: ''; ?>" />
                </div>
            </div>
