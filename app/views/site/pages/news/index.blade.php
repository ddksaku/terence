                                        ...
                                        <div class="timeline-post-wrap">
                                            <div class="post-type">
                                                <a href="{{ \URL::to($news_module_url.'/'.$article->news_url) }}">
                                                    <img
                                                        src="{{ \Config::get('synergy.uploads.images.url') }}resize/{{ $article->news_image ? $article->news_image : $settings->setting_default_image }}"
                                                        @if(($article->news_image && $article->news_image_alt) || (!$article->news_image && $settings->setting_default_image_name))
                                                            alt="{{ $article->news_image ? $article->news_image_alt : $settings->setting_default_image_name }}"
                                                        @endif
                                                        >
                                                </a>
                                            </div>
