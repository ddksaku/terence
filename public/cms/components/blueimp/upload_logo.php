...
$logo_sizes = mysql_fetch_assoc($result);


$handler = new UploadHandler($logo_sizes);
...
class UploadHandler
{
    ...
    function __construct($logo_sizes = null, $options = null, $initialize = true, $error_messages = null) {
            ...
            'image_versions' => array(
                ...
                */
                'thumb' => array(
                    ...
                    //'crop' => true,
                    'max_width' => $logo_sizes['logo_thumb_width'],
                    'max_height' => 10000
                ),
				...
				'resize' => array(
                    ...
                    // dimensions and e.g. create square thumbnails:
                    //'crop' => true,
                    'max_width' => $logo_sizes['logo_resize_width'],
                    'max_height' => 10000
                ),
            )
        );
	...
	protected function rename_file_unique($path, $filename){
		...
		$new_name = strtolower(base64_encode($filename)) . '.' . $ext;
	    ...
	    while(file_exists($path . $new_name)){
		  ...
		  $new_name = strtolower(base64_encode($filename)) . $x  . '.' . $ext;
