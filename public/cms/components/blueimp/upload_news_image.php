...
//Get images sizes
$result = q("SELECT * FROM `{$prefix_table}settings` WHERE `id` =1 LIMIT 0 , 1");
$image_sizes = mysql_fetch_assoc($result);


$handler = new UploadHandler($image_sizes);
            ...
            'image_versions' => array(
                ...
                */
                'thumb' => array(
                    ...
                    //'crop' => true,
                    'max_width' => $image_sizes['thumb_width'],
                    'max_height' => 10000
                ),
				...
				'resize' => array(
                    ...
                    // dimensions and e.g. create square thumbnails:
                    //'crop' => true,
                    'max_width' => $image_sizes['resize_width'],
                    'max_height' => 10000
                ),
